...
- **Custom Anytihng** - Adapt the system to support custom media types and uploading photos

## Challenges

- Decide if this is an app requiring authentication or just a public builder
